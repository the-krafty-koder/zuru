...
class get_forecast_details():

    def __init__(self,location_key):
        self.location_key = location_key

    def get_5_day_forecast(self):
        response = requests.get("http://dataservice.accuweather.com/forecasts/v1/daily/5day/{}?apikey={}".format(self.location_key, ACCU_APIKEY))
    ...
    def get_12_hour_forecast(self):
        response = requests.get("http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/{}?apikey={}".format(self.location_key, ACCU_APIKEY))
    ...
    def get_current_conditions(self):
        response = requests.get("http://dataservice.accuweather.com/currentconditions/v1/{}?apikey={}".format(self.location_key, ACCU_APIKEY))
